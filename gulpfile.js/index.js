...
exports.build = gulp.series(clean, copyFile, layoutHTML, sass, loginjs, vendorsJs)

exports.default = gulp.series(clean, copyFile, layoutHTML, sass, loginjs, vendorsJs, gulp.parallel(browser, watch))
